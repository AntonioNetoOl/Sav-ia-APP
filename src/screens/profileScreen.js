    ...
    <View style={styles.root}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.card}>
          <Ionicons name="person-circle-outline" size={64} color="#F1E6A8" />
          <Text style={styles.title}>Minha conta</Text>
          <Text style={styles.text}>
            A área de perfil será implementada em uma próxima etapa. Este acesso já está reservado para ser usado pelo avatar e pelo botão “Acessar meu perfil”.
          </Text>
        </View>
      </ScrollView>
    </View>
...
const styles = StyleSheet.create({
  ...
  text: { color: "rgba(255,255,255,0.75)", fontSize: 14, lineHeight: 21, marginTop: 12, textAlign: "center" },
});
